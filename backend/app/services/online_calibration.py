...
KHÁC calibration.py (hiệu chuẩn theo KHÍ HẬU TỪNG ĐIỂM — ERA5 10 năm, đã
chạy production) — module NÀY hiệu chỉnh theo QUAN SÁT NGƯỜI DÙNG GỬI (đúng
tinh thần federated.py, chỉ tinh hơn về thuật toán). Đặt tên khác hẳn
"calibration" để không đụng module đang sống.
