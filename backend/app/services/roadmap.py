...
FLOWS = [
    ...
    ("S10", "Generative Vision", "signature", "partial",
     ...
     "③ ẢNH 'TƯƠNG LAI' theo kịch bản — ĐÃ LÀM (/api/future/{id} + component "
     "Future): phủ kết quả kịch bản lên chính ảnh vệ tinh THẬT của thửa — nền "
     "là ảnh thật có ngày chụp, lớp phủ là dự phóng vẽ tách khỏi ảnh kèm nhãn "
     "'DỰ PHÓNG' + mức tin cậy. Không model sinh nào, đúng hai hàng rào đặc tả. "
